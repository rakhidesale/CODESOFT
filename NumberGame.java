...
public class NumberGame {
    ...
    private void prepareGUI() {
        ...
        headerLabel2 = new JLabel("Please guess a number between 1-100", JLabel.CENTER);
        ...
        statusLabel1 = new JLabel("Now try and guess my number", JLabel.CENTER);
    ...
    private void start() {
        guessButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String feedbackStr;
                if (guess < number) {
                    feedbackStr = "Your guess is too low";
                } else if (guess > number) {
                    feedbackStr = "Your guess is too high";
                } else {
